...
Course repo for studies in webApp version 4 at BTH. We are going to create a 
...
All applications have some sort of dependencies, this project requires the following set of 
dependencies to be installed and working on your machine before you can run the application.
...
- Expo Application Service `eas-cli` tool, replaces `expo-cli` for SDK v45+
...
[//]: # ( ---------- EXPO APPLICATION SERVICE INSTALLATION ---------- START ---------- )
