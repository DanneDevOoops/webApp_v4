 ...
 * @property {{ item: Product }} ProductItem - The route parameter for the product item screen,
 * containing a product item.
 */
 ...
 * @property {string} article_number - Article number of the product, serving as an additional
 * identifier.
 ...
 * @property {string} api_key - An API key associated with the product for identification or
 ...
 *
 * This interface defines the structure of the props that are passed to the `ProductListItem`
 * component.
 *
 ...
 *
 * This interface outlines both the required fields for identifying the product and the
 ...
 * @property {string} [specifiers] - Optional. New or updated specifications or characteristics
 * of the product.
